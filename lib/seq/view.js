...
let ShowInst = new LaunchPadRenderer(d, m, 'channel', MidiChannelChange, amber, () => {
...
let ShowRepeats = new LaunchPadRenderer(d, s, 'repeat', Cyclers.repeat.change, amber, () => {
    return Font.get(seq().getPage().repeat);
});

let ShowSpeed = new LaunchPadRenderer(d, s, 'speed', Cyclers.speed.change, amber, () => {
    return Font.get(seq().getPage().speed);
});

let ShowPlayback = new LaunchPadRenderer(d, s, 'playback', Cyclers.playback.change, amber, () => {
